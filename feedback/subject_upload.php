...
<title>Subject List Upload</title>
</head>

<body>
<form action="subject_upload.php" method="post" name="form1" enctype="multipart/form-data">
 ...
 // echo "Temp file: " . $_FILES['excel']['tmp_name'] . "<br />";
   ...
   if (file_exists("dir/" . $_FILES['excel']['name']))
    ...
    //  echo "Stored in: " . "dir/" . $_FILES['excel']['name'];
	 ...
	 echo"<script>document.location.href = \"subject_list.php\";</script>";
